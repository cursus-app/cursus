...
import { validatePasswordServer, computeHibpPrefixSuffix, isPasswordPwned } from '~~/server/utils/passwordPolicy'
...
describe('server/utils/passwordPolicy — isPasswordPwned()', () => {
  ...
  it('retourne false si le suffix est absent de la réponse HIBP', async () => {
    ...
    fetchMock.mockResolvedValueOnce({
      ok: true,
      text: async () => 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA:5\nBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB:3\n',
    })
